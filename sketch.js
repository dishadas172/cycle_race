...
var obstacle1Img, obstacle2Img; //DD
...
function preload(){
  ...
  obstacle2Img = loadAnimation("obstacle3.png");
  ...
  if (World.frameCount % 120 == 0){
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    if(obstacleG.isTouching(mainCyclist)){
      ...
      obstacle.addAnimation("obstacle", obstacle2Img);
    }
...
function spawnObstacle(){
  ...
  obstacle.addAnimation("obstacle", obstacle1Img);
